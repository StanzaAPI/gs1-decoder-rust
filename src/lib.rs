//! Official Rust Client for GS1 Barcode & Digital Link Decoder
...
impl Gs1DecoderClient {
    pub fn new(api_key: Option<String>, base_url: Option<String>) -> Self {
        ...
        Self {
            ...
            tool_url: "https://stanzaapi.com/tools/gs1-decoder",
        }
    }
    ...
    pub async fn validate<T: for<'de> Deserialize<'de>>(&self, payload: serde_json::Value) -> Result<ApiResponse<T>, reqwest::Error> {
        self.send_request("/api/v1/decode", reqwest::Method::POST, Some(payload)).await
    }
